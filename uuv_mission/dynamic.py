...
import pandas as pd
from uuv_mission.control import PD_Controller
...
class ClosedLoop:
    ...
    def simulate(self,  mission: Mission, disturbances: np.ndarray) -> Trajectory:
        ...
        for t in range(T):
            ...
            actions[t] = self.controller.response(observation_t,mission.reference[t])
    ...
    def simulate_without_random_disturbances(self, mission: Mission, variance: float = 0.5) -> Trajectory:
